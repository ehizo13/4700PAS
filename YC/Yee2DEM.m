...
for i = 1:nSteps
    ...
    for k = 1:Reg.n
        ...
        if bc{k}.NumS > 0
          ...
          if bc{k}.NumS > 1
              Einc2 = bc{k}.s(2).fct(yC{k}, i, t, bc{k}.s(2).paras);  % Compute the electric field for the second source
              Eincp2 = bc{k}.s(2).fct(yC{k}, i, t - ds / c_c / 2, bc{k}.s(2).paras);  % Shifted field for the second source
              
              % Add the second source to the fields
